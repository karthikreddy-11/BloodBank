...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2024 at 10:28 AM
...
(1, 'chennai', '09999999999', 'bloodbankdonation@gmail.com');
...
(1, 'Anuj', 'anuj@gmail.com', '9923471025', 'I need O+ Blood.', '2024-10-06 00:52:11', 1);
...
(6, 'karthik', '1234567890', 'asdfghjkl@gmail.com', 20, 'Male', ' 1', 'asdfg');
...
(3, 'About Us ', 'aboutus', '<ul style=\"margin-bottom: 1rem; color: rgb(33, 37, 41); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, &quot;Helvetica Neue&quot;, Arial, &quot;Noto Sans&quot;, sans-serif, &quot;Apple Color Emoji&quot;, &quot;Segoe UI Emoji&quot;, &quot;Segoe UI Symbol&quot;, &quot;Noto Color Emoji&quot;; font-size: 16px; font-weight: 400; background-color: rgb(237, 232, 245);\"><li>Blood Bank and Donation Management System (BBDMS) is a web-based platform for efficient blood bank operations.</li><li>It ensures proper storage, handling, and testing of blood to minimize the risk of transfusion-related events.</li><li>The system tracks blood donations from various donation events, ensuring systematic management of blood bags.</li><li>BBDMS allows for the quick and reliable registration of donors and recipients.</li><li></li><li>It simplifies the process of locating and managing blood inventory for hospitals and medical facilities.</li><li>The platform is designed to ensure the safe and organized distribution of blood to those in need.</li><li>The system enhances coordination between donors, blood banks, and recipients for efficient service.</li></ul>                    '),
